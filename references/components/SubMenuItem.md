...
```
children, closeMenuOnClick, color, disabled, href, leftSection, n_clicks, refresh, rightSection, target
```
...
| `closeMenuOnClick` | ? | See all-components.md for details |
