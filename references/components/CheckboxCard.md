...
```
checked, children, defaultChecked, disabled, persisted_props, persistence, persistence_type, radius, value, withBorder, wrapperProps
```
...
| `defaultChecked` | ? | See all-components.md for details |
