...
**Component**: `dmc.CheckboxIndicator`
...
```
autoContrast, checked, color, disabled, icon, iconColor, indeterminate, indeterminateIcon, persisted_props, persistence, persistence_type, radius, size, wrapperProps
```
