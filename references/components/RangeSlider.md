...
```
color, disabled, domain, inverted, label, labelAlwaysOn, labelTransitionProps, marks, max, maxRange, min, minRange, name, persisted_props, persistence, persistence_type, precision, pushOnOverlap, radius, restrictToMarks, scale, showLabelOnHover, size, step, thumbChildren, thumbFromLabel, thumbSize, thumbToLabel, updatemode, value
```
...
| `maxRange` | ? | See all-components.md for details |
| `min` | ? | See all-components.md for details |
| `minRange` | ? | See all-components.md for details |
...
| `pushOnOverlap` | ? | See all-components.md for details |
...
| `thumbFromLabel` | ? | See all-components.md for details |
| `thumbSize` | ? | See all-components.md for details |
| `thumbToLabel` | ? | See all-components.md for details |
